"""
Django settings for cobranza_backend project.
...
SECRET_KEY = 'django-insecure-i9+2v$_ol=pgt5guj1r5kb3m-og_9-q46q8zh@bf-@%i@xldum'
...
WSGI_APPLICATION = 'cobranza_backend.wsgi.application'
